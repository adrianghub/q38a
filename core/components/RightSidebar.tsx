...
const RightSidebar = () => {
  return (
    <aside className="custom-scrollbar background-light900_dark200 light-border fixed right-0 top-0 flex h-screen w-[350px] flex-col gap-6 overflow-y-auto border-l px-4 pt-36 shadow-light-300 dark:shadow-none max-xl:hidden">
      <div>
